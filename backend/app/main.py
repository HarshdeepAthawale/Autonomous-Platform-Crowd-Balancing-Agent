...
from .routers import agent, debug, density, override, scan, scheduling, state, translate, tts
...
for r in (scan, density, state, scheduling, override, agent, debug, tts, translate):
