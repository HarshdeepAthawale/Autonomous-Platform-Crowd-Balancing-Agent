...
const CX = 100, CY = 100, R = 80, STROKE = 14
...
function Tick({ frac, color }) {
  ...
  return <line x1={inner.x} y1={inner.y} x2={outer.x} y2={outer.y} stroke={color} strokeWidth={2} strokeLinecap="round" />
}
...
export default function DensityGauge({ densityPct = 0, zoneColor = '#5C8A3A', label = '', trend }) {
  ...
  return (
    <div style={{ position: 'relative', width: 168, height: 150, flexShrink: 0 }}>
      <svg viewBox="0 0 200 188" width={168} height={158} style={{ overflow: 'visible' }}>
        {/* Track */}
